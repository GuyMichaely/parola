...
The canonical schema is strict. Retired noun `articleMode`, string article-profile encodings, and syntax `articleMode`/`numberMode` properties are not accepted.
